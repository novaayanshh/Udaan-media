  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <button
        type="submit"
        disabled={submitting}
        className="mt-2 bg-primary hover:bg-primary-light text-white font-heading font-bold px-8 py-3.5 rounded-sm transition-colors self-start disabled:opacity-60 disabled:cursor-not-allowed"
      >
